...
namespace Business.Repositories
{
    public class AmenityRepository : IAmenityService
    {
        ...
        public async Task<SubCatagory> Get(int? id)
        {
            ...
            var data = await _context.SubCatagories.Where(n => n.Id == id && n.Catagory.Name.ToUpper() == "AMENITIES")
        ...
        {
            var data = await _context.SubCatagories.Where(n => n.Catagory.Name.ToUpper() == "AMENITIES")
                                                   .Include(n => n.Catagory)
                                                   .ToListAsync();
